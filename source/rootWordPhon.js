  ...
  */
  NativeWeights = {
    "zh": 14.1 + /*wu*/ 1.2 % + /*cjy*/ 0.72 + /*hsn*/ 0.58 + /*hak*/ 0.46 +
      /*gan*/
      0.33 + /*mnp*/ 0.16 + /*cdo*/ 0.14 + /*hmx*/ 0.13 +
      /*STR*/
      1.33,
    "es": 5.85,
    "en": 5.52 + /*ER*/ 2.24,
    ...
    "id": 1.16 + /*jv*/ 1.25 + /*th*/ 0.86 + /*su*/ 0.57 + /*tl*/ 0.42 +
      /*ceb*/
      0.32 + /*mg*/ 0.28 + /*mad*/ 0.23 + /*ilo*/ 0.14 +
      /*hil*/
      0.12 + /*ANR*/ 0.5 + /*TKR*/ 0.14,
    "te": 1.15,
    "ta": 1.06 + /*DR*/ 0.14,
    ...
    "sw": /*yo*/ 0.42 + /*ff*/ 0.37 + /*ny*/ 0.17 + /*ak*/ 0.17 +
      /*rw*/
      0.15 + /*rn*/ 0.13 + /*sn*/ 0.13 + /*mos*/ 0.11 +
      /*xh*/
      0.11 + /*NCR*/ 4.65,
    "am": 0.37 + /*om*/ 0.36 + /*so*/ 0.22,
    "ro": 0.37,
    "az": 0.34,
    "nl": 0.32,
    "ku": 0.31,
  ...
  */
  ...
  var Bit4Alphabet = ["m", "k", "i", "a", "y", "u", "p", "w",
    ...
    matchReplaceArray = [
      ...
      ["[0-9]", ""],
      [String.fromCharCode(778), ""],
      ["7", ""],
      ["\\+", ""],
      ["`", ""],
      [String.fromCharCode(771), ""],
      ["1", ""],
      [String.fromCharCode(809), ""],
...
function addGlyphs(obj, glyphWord, weight) {
  var length = glyphWord.length,
    ...
    initialSegment = arrayUnique(glyphAr.slice(initialStart, segmentLength)),
...
function main() {
  function makeWord(line, phonObjX, rootPhonObjX, availableList, rootCount,
    ...
    var phonEntry,
      ...
      G28RootMax = 5898,
      someG28Words = ["litre"],
      someG32Words = ["ob-", "-oma", "iraq",
        /*"liberia", "litre", "brachylogia", 
  ...
  wordLines.forEach(function(line) {
    ...
    if (!rootList["X" + line[0]]
      ...
      tmpObj = makeWord(line, phonObjX, rootPhonObjX,
        availableList, rootCount,
        gramCount, shortGramCount);
